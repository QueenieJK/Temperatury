...
int main()
{
    ...
    while (true) {
        ...
        switch (wybor) {
        case 1:
            cout << "Podaj wartoœc F: " << endl;
            cin >> fahr;
            if (check(fahr, 'F') == -999.0) {
                cout << "Nie ma takiej temperatury" << endl;
                cout << "Wcisnij enter aby kontynuowaæ: " << endl;
                cin.ignore(); cin.get();
            }
            else {
                celsius = FtoC(fahr);
                if (dataCounter + 1 >= 100) {
                    cout << "Pamiêæ pe³na, nie mo¿na zapisaæ wiêcej danych." << endl;
                }
                else {
        ...
        case 7:
            ...
            cout << "Wcisnij enter aby kontynuowaæ: ";
            cin.ignore();
            cin.get();
            break;
        case 8:
            cout << "Wybrano zakoñczenie dzia³ania programu" << endl;
            return 0;
        default:
